...
| Format de fichier (FAIR: I1): <span style="font-size: 11px; font-style: italic; margin-top: 5px; display: block;">(Voir: [Liste of file formats](https://en.wikipedia.org/wiki/List_of_file_formats))</span>  | <span class="overview-table-yes">optionnel</span>   | DC.Format   						  |  _(Incorporer ces informations dans le champ “Description” lors de la saisie des métadonnées)_   |
