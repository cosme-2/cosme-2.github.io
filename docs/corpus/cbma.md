...
| <span class="corpus-table-header-left">Documentation technique</span> 	 | Corpus hagiographique "bourguignon": La documentation est incluse dans le dépôt des données. <span style="display: block; padding-bottom: 20px;"/> Cartulaires (AD de la Côte d'Or): Aucune documentation n’est nécessaire, les données sont explicites en l’état.|
