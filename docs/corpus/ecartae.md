...
| <span class="corpus-table-header-left">Dépôt de données</span>          	 | [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.7252240.svg)](https://doi.org/10.5281/zenodo.7252240){:target="_blank"} |
| <span class="corpus-table-header-left">Citation bibliographique</span>     | Combalbert, Grégory. (2022). Actes des évêques d'Évreux (e-Cartae) [Data set]. Zenodo. https://doi.org/10.5281/zenodo.7252240 |
