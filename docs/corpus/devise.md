...
| <span class="corpus-table-header-left">Documentation technique</span>   	 | [MySQL Documentation](https://dev.mysql.com/doc/){:target="_blank"} <br/> La documentation supplémentaire est également incluse dans le dépôt des données. |
