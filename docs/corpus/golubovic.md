...
| <span class="corpus-table-header-left">Format de données</span>                                            | _transformation en cours vers xml_ |
| <span class="corpus-table-header-left">Standards des données</span>                                        | _en cours vers XML TEI P5_ |
| <span class="corpus-table-header-left">Taille des fichiers</span>                                          | - |
| <span class="corpus-table-header-left">Unité de donnée et nb.d’unités</span>                               | 2000 textes |
| <span class="corpus-table-header-left">Logiciels spécifiques nécessaires pour la lecture des données</span>| non  |
| <span class="corpus-table-header-left">Plateforme d’affichage et de stockage des données</span>            | _en cours vers TELMA Chartes_<sup>*</sup> |
...
| I1. Les (méta)données utilisent un langage formel, accessible, partagé et largement répandu pour la représentation des connaissances | <span class="overview-table-no">Non</span> |
