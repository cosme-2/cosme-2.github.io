...
| <span class="corpus-table-header-left">Unité de donnée et nb.d’unités</span>                               | 5866 textes |
...
| <span class="corpus-table-header-left">Documentation technique</span>   	 | [Schema JSON"](https://github.com/cosme-2/corpus/tree/main/bullarium-franciscanum) |
