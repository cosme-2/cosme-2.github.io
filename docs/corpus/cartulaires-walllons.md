---
layout: default
title: Cartulaires walllons
parent: Corpus
nav_order: 7
---

# Cartulaires walllons
{: .no_toc }
...
| <span class="corpus-table-header-left">Unité de donnée et nb.d’unités</span>                               | 723 notices |
...
| <span class="corpus-table-header-left">Dépôt de données</span>          	 | [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.5752563.svg)](https://doi.org/10.5281/zenodo.5752563){:target="_blank"} |
| <span class="corpus-table-header-left">Citation bibliographique</span>  	 | Bertrand, Paul. (2021). Cartulaires wallons. Répertoire des cartulaires d'institutions religieuses médiévales sises dans l'espace wallon actuel [Data set]. Zenodo. https://doi.org/10.5281/zenodo.5752563 |
| <span class="corpus-table-header-left">Documentation technique</span>   	 | [Schemas JSON](https://github.com/cosme-2/corpus/tree/main/cartulaires-walllons){:target="_blank"} <br/> La documentation supplémentaire est également incluse dans le dépôt des données. |
